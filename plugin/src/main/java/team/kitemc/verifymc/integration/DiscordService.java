...
public class DiscordService {
    ...
    /**
     * Set the user repository for persistent storage
     * @param userRepository repository instance
     */
    public void setUserRepository(UserRepository userRepository) {
        this.userRepository = userRepository;
        debugLog("UserRepository set for Discord service");
    }
    ...
    public DiscordCallbackResult handleCallback(String code, String state) {
        ...
        try {
            ...
            if (userRepository != null) {
                boolean updated = userRepository.updateDiscordId(username, user.id);
                if (updated) {
